  ...
  if (!sizeId) {
    ...
    return (
      <div>
        ...
        {!sizeId && !isCard && (
          <div className="text-[#2d6b54] text-xs leading-4 mt-1">
  ...
  return (
    <div>
      ...
      {selectedSize.price !== discountedPrice && (
        <span className="text-muted inline-block text-xl font-normal leading-6 mr-2 line-through">
          ${selectedSize.price.toFixed(2)}
        </span>
      )}
      {selectedSize.discount > 0 && (
        <span className="inline-block text-[#2d6b54] text-xl leading-6">
