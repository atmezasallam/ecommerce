          ...
          <table className="w-full mt-1.5">
            <thead className="w-full">
              {fee === extraFee || extraFee === 0 ? (
                ...
                >
                  <td className="w-full bg-base px-2 py-0.5 rounded-sm">
                    Fee per item
                  </td>
                  <td className="w-full bg-base px-2 py-0.5 rounded-sm">
                    ${fee}
            ...
            <tbody>
              <tr
                ...
                style={{ gridTemplateColumns: "4fr 1fr" }}
              >
                <td className="w-full bg-base px-2 py-0.5 ">Quantity</td>
                <td className="w-full bg-base px-2 py-0.5 ">x{quantity}</td>
              </tr>
              <tr className="flex gap-x-1 text-xs px-4 mt-1 text-center font-semibold">
                <td className="w-full bg-dark text-white px-1 py-1">
          ...
          <table className="w-full mt-1.5">
            ...
            <tbody>
              ...
              <tr
                ...
                style={{ gridTemplateColumns: "4fr 1fr" }}
              >
                <td className="w-full bg-base px-2 py-0.5 ">Weight</td>
                <td className="w-full bg-base px-2 py-0.5 ">{weight}kg</td>
              </tr>
              <tr className="flex gap-x-1 text-xs px-4 mt-1 text-center font-semibold">
                <td className="w-full bg-dark text-white px-1 py-1">
                  <span>
