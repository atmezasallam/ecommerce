    ...
    <div>
      <div className="space-y-1">
        ...
        <div
          ...
          className="max-w-[calc(100%-2rem)] ml-4 flex items-center bg-base hover:bg-base h-5 cursor-pointer"
        >
