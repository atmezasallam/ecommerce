...
const Select: FC<Props> = ({
  ...
  return (
    <div className="relative w-full z-50">
        ...
        <div className="relative">
          ...
          <input
            className={cn(
              ...
              {
                "ring-1 ring-[transparent] focus:ring-accent":
      ...
      {isOpen && (
        <div className="absolute top-16 w-full left-0 rounded-xl border  p-4 bg-surface shadow-lg">
          <p className="font-semibold text-xs text-subtle">
            {subPlaceholder}
          </p>
