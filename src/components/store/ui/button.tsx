  ...
  "group/button relative w-full flex items-center justify-center gap-x-1 text-white rounded-3xl leading-6 font-bold whitespace-nowrap border border-orange-border cursor-pointer transition-all duration-300 ease-bezier-1 select-none",
  {
    variants: {
      variant: {
        ...
        black: "bg-dark",
        pink: "bg-[#ffe6e7] text-[#2d6b54] hover:bg-[#e4cdce] hover:text-white",
        outline:
          "bg-transparent hover:bg-orange-background hover:text-white text-[#2d6b54] rounded-md border-orange-background px-2 !h-7 text-sm font-normal",
        "orange-gradient":
        ...
        gray: "bg-[#E8EAFB] text-[#222] border-[#E8EAFB] inline-block w-full h-[36px] leading-[36px] text-[14px] font-bold text-center rounded-full cursor-pointer",
      },
      size: {
        default: "h-11 py-2",
